...
Regulation telegraphs. [CIRCIA](../appendix/references.md#regulation-as-drag-and-driver-and-the-compliance-security-gap) was law four years before its reporting rule lands; the EU's [Cyber Resilience Act](../appendix/references.md#regulation-as-drag-and-driver-and-the-compliance-security-gap) and AI Act each signaled years of obligations before the first one bound anyone. In a lightly regulated domain the signal is usually there to read well ahead of the rule; whether you act on it depends on where your organization operates today and where it aspires to operate. A domain you already score high on, AI Saturation or Supply Chain Complexity, is where regulation tends to move first; when it does, an organization that built no capacity under light regulation absorbs a high-stakes mandate from a standing start.
