...
| Concurrent change overlap (top two initiatives)? | Share two or more of {people, approval, sponsor, system} | Share one | Share none |
...
[:octicons-arrow-left-24: Back to Crisis Events](crisis-events.md){ .md-button }
