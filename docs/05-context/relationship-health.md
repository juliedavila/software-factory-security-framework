...
<figure>
  <svg viewBox="0 0 680 580" role="img" aria-labelledby="sf2-rh-title sf2-rh-desc" xmlns="http://www.w3.org/2000/svg" style="max-width:680px;width:100%;height:auto;font-family:'Source Serif 4',Georgia,serif;">
    ...
    <text x="360" y="34" font-size="16.5" font-weight="700" fill="#2C4A6B" text-anchor="middle">Friction governs adoption, the mandate does not</text>
  ...
  <figcaption style="font-size:0.85rem;color:#555;margin-top:0.4rem;">Friction governs adoption, the mandate does not. The paved road is mandatory and low-friction at once, the cell the mandatory-versus-voluntary frame misses.</figcaption>
</figure>
