...
[:octicons-arrow-right-24: Edit this page](https://github.com/juliedavila/software-factory-security-framework/edit/master/docs/07-relationships/nist-ssdf.md){ .md-button }
