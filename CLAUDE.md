...
- **Version** - single source of truth is `docs/appendix/references.md` "About This Framework". Current: **v1.3.2**. Do not stamp versions on individual content pages (they rot).
